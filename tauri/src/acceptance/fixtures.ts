...
export const cleanupAcceptanceFixture: CleanupWorkbenchState = {
  ...
  diskOverview: [
    ...
    {
      drive: "D:",
      totalBytes: 1024000000000,
      freeBytes: 512000000000,
  ...
  recycleBin: {
    generatedAt: "1784213400",
    itemCount: 1,
    totalBytes: 4096,
    recoverableCount: 1,
    items: [
      {
        id: "fixture-recycle-item",
        name: "old-fixture.log",
        originalPath: "D:\\Fixture\\old-fixture.log",
        recyclePath: "D:\\$Recycle.Bin\\fixture\\$Rfixture.log",
        sourceDrive: "D:",
        size: 4096,
        deletedAt: "2026-07-21 10:00:00",
        recoverable: true,
      },
    ],
    volumes: [
...
export const runtimeAcceptanceFixture: RuntimeWorkbenchState = {
  runtimes: [
    {
      id: "runtime-managed-jdk-21",
      kind: "jdk",
      displayName: "Java / JDK",
      ecosystem: "java",
      version: "21.0.4",
      executable: "C:\\DevEnv\\runtimes\\jdk-21\\bin\\java.exe",
      runtimeRoot: "C:\\DevEnv\\runtimes\\jdk-21",
      source: "DevEnv managed registry",
      management: "managed",
      sourceAuthority: "devenv-managed-registry",
      switchModes: ["managed"],
      switchEligible: true,
      switchBlockers: [],
      verificationFingerprint: "managed-jdk-fixture",
      current: true,
      installedAt: "2026-07-20T08:00:00Z",
    },
    {
      id: "runtime-external-python-313",
      kind: "python",
      displayName: "Python",
      ecosystem: "python",
      version: "3.13.0",
      executable: "C:\\Users\\David\\AppData\\Local\\Programs\\Python\\Python313\\python.exe",
      runtimeRoot: "C:\\Users\\David\\AppData\\Local\\Programs\\Python\\Python313",
      source: "Python registry",
      management: "external",
      sourceAuthority: "python-registry",
      switchModes: ["external-user"],
      switchEligible: true,
      switchBlockers: [],
      verificationFingerprint: "external-python-fixture",
      current: false,
    },
    {
      id: "runtime-managed-jdk-17",
      kind: "jdk",
      displayName: "Java / JDK",
      ecosystem: "java",
      version: "17.0.12",
      executable: "C:\\DevEnv\\runtimes\\jdk-17\\bin\\java.exe",
      runtimeRoot: "C:\\DevEnv\\runtimes\\jdk-17",
      source: "DevEnv managed registry",
      management: "managed",
      sourceAuthority: "devenv-managed-registry",
      switchModes: ["managed"],
      switchEligible: true,
      switchBlockers: [],
      verificationFingerprint: "managed-jdk-17-fixture",
      current: false,
      installedAt: "2026-07-20T08:00:00Z",
    },
  ],
  ...
  strongVerification: {
    ...
    summary: ["Command-level fixture verification."],
    items: [{
      runtimeId: "runtime-managed-jdk-21",
      kind: "jdk",
      version: "21.0.4",
      path: "C:\\DevEnv\\runtimes\\jdk-21",
      registered: true,
      current: true,
      environmentEffective: true,
      status: "current",
      ...
      runtimeId: "runtime-managed-jdk-17",
      kind: "jdk",
      version: "17.0.12",
      path: "C:\\DevEnv\\runtimes\\jdk-17",
      registered: true,
      current: false,
      environmentEffective: false,
      status: "available",
      report: [],
      checks: [{
        id: "java-version",
        ...
        command: "java.exe -version",
        expected: "17",
        actual: "openjdk version 17.0.12",
        status: "passed",
        elapsedMs: 38,
        required: true,
        suggestion: "No action required.",
      ...
      runtimeId: "runtime-external-python-313",
      kind: "python",
      version: "3.13.0",
      path: "C:\\Users\\David\\AppData\\Local\\Programs\\Python\\Python313",
      registered: false,
      current: false,
      environmentEffective: false,
