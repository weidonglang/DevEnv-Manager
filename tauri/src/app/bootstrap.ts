...
import { createRiskToken } from "../core/risk";
import type {
  AppSnapshot,
  EnvSnapshot,
  ConfigView,
  ...
  <main class="shell">
    <aside class="sidebar">
      ...
      <nav class="nav">
        ...
        <button class="nav-item active" data-view="overview">${icon(Gauge)}<span>Dashboard</span></button>
        <button class="nav-item" data-view="runtimes">${icon(Terminal)}<span>Runtimes</span></button>
        <button class="nav-item" data-view="environment">${icon(Route)}<span>Environment</span></button>
        <button class="nav-item" data-view="project">${icon(FolderSearch)}<span>Projects</span></button>
        <button class="nav-item" data-view="ports">${icon(Network)}<span>Ports & Services</span></button>
        <span class="nav-group">System bindings</span>
        <button class="nav-item" data-view="toolbox">${icon(Hammer)}<span>File Associations</span></button>
        <button class="nav-item" data-view="maintenance">${icon(Shield)}<span>Cleanup</span></button>
        <button class="nav-item" data-view="toolchains">${icon(PackageCheck)}<span>Toolchains</span></button>
        <button class="nav-item" data-view="platforms">${icon(Cpu)}<span>Profiles</span></button>
        <button class="nav-item" data-view="learning">${icon(FileText)}<span>Reports</span></button>
        <button class="nav-item" data-view="doctor">${icon(Shield)}<span>Settings</span></button>
      </nav>
    </aside>
