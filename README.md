...
面向 Windows 的开发环境诊断器与安全操作面板。当前版本：**1.5.0**。
...
- `tauri\src-tauri\target\release\bundle\nsis\DevEnv Manager_1.5.0_x64-setup.exe`
- `tauri\src-tauri\target\release\bundle\msi\DevEnv Manager_1.5.0_x64_en-US.msi`
...
| 文件 | 1.0.0 | Phase 1 | 1.1.0 | 1.3.0 | 1.4.0 | 1.5.0 | 1.5.0 相对 1.4.0 |
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| `dailytools-tauri.exe` | 4,758,016 B | 4,726,272 B | 4,826,624 B | 5,047,808 B | 5,296,128 B | 5,678,080 B | +381,952 B |
| `devenv.exe` | 2,073,600 B | 2,066,944 B | 2,102,784 B | 2,088,960 B | 2,148,352 B | 2,355,712 B | +207,360 B |

Phase 2 没有单独发布可复现的 release 二进制，因此使用最近发布的 1.1.0 作为更严格基线。1.5.0 继续不引入大型依赖；Phase 5 相对 1.4.0 主程序增加 381,952 B、CLI 增加 207,360 B，低于 5 MB 体积上限。
...
感谢所有提交 Issue、复现步骤、截图、日志和建议的用户。1.5.0 的环境可靠性中心、安全说明体系，以及 Python/pip、Go、Gradle、Java 本地 JDK 稳定化入口，均来自近期真实反馈。
